...
/*********************************************************************
* Function: bool Output_Enable(OUTPUT output);
*
* Overview: Configures the LED for use by the other LED API
*
* PreCondition: none
*
* Input: OUTPUT led - enumeration of the LEDs available in this
*        demo.  They should be meaningful names and not the names of
*        the OUTPUTs on the silk-screen on the board (as the demo code may
*        be ported to other boards).
*
* Output: none
*
