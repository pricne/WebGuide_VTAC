...
/*Port E*/
//#define LED_D3_LAT      LATEbits.LATE0 //pin93
//#define LED_D3_LAT      LATEbits.LATE1 //pin94
//#define LED_D3_LAT      LATEbits.LATE2 //pin98
//#define LED_D3_LAT      LATEbits.LATE3 //pin99
//#define LED_D3_LAT      LATEbits.LATE4 //pin100
//#define LED_D3_LAT      LATEbits.LATE5 //pin3
//#define LED_D3_LAT      LATEbits.LATE6 //pin4
//#define LED_D3_LAT      LATEbits.LATE7 //pin5
//#define LED_D3_LAT      LATEbits.LATE8 //pin18
//#define LED_D3_LAT      LATEbits.LATE9 //pin19
//
//#define LED_D3_TRIS     TRISEbits.TRISE0
//#define LED_D3_TRIS     TRISEbits.TRISE1
//#define LED_D3_TRIS     TRISEbits.TRISE2
//#define LED_D3_TRIS     TRISEbits.TRISE3
//#define LED_D3_TRIS     TRISEbits.TRISE4
//#define LED_D3_TRIS     TRISEbits.TRISE5
//#define LED_D3_TRIS     TRISEbits.TRISE6
//#define LED_D3_TRIS     TRISEbits.TRISE7
...
bool LED_Get(LED led)
{
    switch(led)
    {
        ...
        case LED_4:
            return ( (LED_4_LAT == LED_ON) ? true : false );

        case LED_5:
            return ( (LED_5_LAT == LED_ON) ? true : false );

        case LED_6:
            return ( (LED_6_LAT == LED_ON) ? true : false );

        case LED_7:
            return ( ( LED_7_LAT == LED_ON ) ? true : false ) ;

        case LED_8:
            return ( ( LED_8_LAT == LED_ON ) ? true : false ) ;
...
void LED_Enable(LED led)
{
    ...
    {
        case LED_1:
            LED_1_TRIS = PIN_OUTPUT;
            break;

        case LED_2:
            LED_2_TRIS = PIN_OUTPUT;
            break;

        case LED_3:
            LED_3_TRIS = PIN_OUTPUT;
            break;

        case LED_4:
            LED_4_TRIS = PIN_OUTPUT;
            break;

        case LED_5:
            LED_5_TRIS = PIN_OUTPUT;
            break;

        case LED_6:
            LED_6_TRIS = PIN_OUTPUT;
            break;

        case LED_7:
            LED_7_TRIS = PIN_OUTPUT;
            break;

        case LED_8:
            LED_8_TRIS = PIN_OUTPUT;
            break ;
